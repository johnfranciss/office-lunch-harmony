...
const orderFormSchema = z.object({
  ...
  paidBackAmount: z.coerce.number().min(0, {
    message: "Please enter a valid amount.",
  }),
});
...
export function OrderForm() {
  ...
  const paidBackAmount = form.watch("paidBackAmount") || 0;
  const changeAmount = paidBackAmount - totalOrderAmount;
  const paymentStatus = 
            ...
            <div className="border rounded-md p-4 bg-muted/30">
              <div className="space-y-3">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Amount Paid Back by Office Boy</FormLabel>
                      <FormControl>
